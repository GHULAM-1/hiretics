...
export default function CreateCampaignCard() {
  return (
    <>
      <div className="p-5 max-w-[328px] h-[210px]  w-[328px] border border-input rounded-md shadow-md flex flex-col justify-center items-center hover:bg-primaryHoverLight group">
